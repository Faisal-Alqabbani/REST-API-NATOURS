...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZmFpc2FsLTEyIiwiYSI6ImNrN3ExY3FsMzAxdDEzZm15OGZ1ZTFhb3IifQ.h4kG5UO98Sx1eJN_m0ls9w';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/faisal-12/ckawy4m7803xr1iofs1nj5ux2',
    scrollZoom: false // center: [46.722243, 24.752977],
    // zoom: 5,
    // interactive: false,
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description)).addTo(map); // exteds map bounds to include the current location
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            // true meand reload from the server not just the browser
            if (res.data.status === 'success') {
          ...
          case 7:
            ...
            showAlrt('error', 'Error logging out ');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "Your ".concat(type.toUpperCase(), " updated successfuly"));
            }
...
var stripe = Stripe('pk_test_51GryYXKnhobCjn8dRB4y7Y6vIn7656V8bDvVJWQm34QKWk0XQSBciWPINSm1sFS6tQWDYxBGKhagDHD6oT6Y2tVu00Co51U6z4');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); // 2) Create checkout form pluse charge credit card
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.get('http://localhost:3000/api/v1/users?limit=5');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'User added successfuly');
            }
...
var btnUsers = document.getElementById('users_here');
var btnAddUser = document.getElementById('add_new_user'); // VALUE
//DELEGATION
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  ...
  console.log(form);
  (0, _updateSettings.updateData)('Data', form); // const email = document.getElementById('email').value;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 7;
            return (0, _updateSettings.updateData)('password', {
...
if (btnUsers) btnUsers.addEventListener('click', function (e) {
  e.preventDefault();
  (0, _getUsers.getAllUsers)();
});
if (btnAddUser) btnAddUser.addEventListener('click', /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            email = document.getElementById('email_new_user').value;
            password = document.getElementById('password_new_user').value;
            passwordConfirm = document.getElementById('passwordC_new_user').value;
            console.log(name, email, password, passwordConfirm);
            _context2.next = 8;
            return (0, _getUsers.createUser)(name, email, password, passwordConfirm);
